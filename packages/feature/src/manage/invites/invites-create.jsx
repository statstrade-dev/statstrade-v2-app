...
// statstrade-web.feature.manage.invites.invites-create/FormSelect [20] 
...
// statstrade-web.feature.manage.invites.invites-create/InviteCreate [57] 
export function InviteCreate(){
  ...
  let createInvite = kd.get_in(api,["mutations","organisation_invite_email_create"]);
  console.log(api);
  let onSubmit = function (data){
    createInvite.mutateAsync({
      ...
      "emails":(data.channel == "email") ? data.emails : null
    });
    setView("list");
  };
