...
// sznui.lib.edge.remote.api-nextjs/debug-testusers-list [36] 
export function debug_testusers_list(_,options = {}){
  return api_nextjs.callApi("api/debug/create-testuser","GET",{},options);
}

// sznui.lib.edge.remote.api-nextjs/debug-testusers-delete [43] 
