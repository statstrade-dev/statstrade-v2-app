...
import * as event_box from '@statstrade/group/lib/xt/lang/event-box'

// js.react.ext-box/createBox [11] 
export function createBox(initial){
  return event_box.make_box(initial);
}

// js.react.ext-box/useListenBox [17] 
...
// js.react.ext-box/attachLocalStorage [52] 
